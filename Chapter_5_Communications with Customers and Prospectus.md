...
1. **Part 1**: 
   ...
   - **Contents**:
     ...
     - Information on how the firm is structured, including ownership.
     - Disciplinary history of the firm and its management personnel.
...
2. **Part 2A (Firm Brochure)**: 
   ...
   - **Contents**:
     ...
     - Fee structures and how clients are billed.
     - Methods of analysis, investment strategies, and risk factors.
     - Disclosures about potential conflicts of interest.
     - Information about the firm’s disciplinary history, if applicable.
...
3. **Part 2B (Brochure Supplement)**:
   ...
   - **Contents**:
     ...
     - Disciplinary actions, if any, involving these individuals.
     - Potential conflicts of interest related to the supervised persons.
     - Other business activities these individuals may be involved in outside their role as investment advisers.

4. **Part 3 (Form CRS - Client Relationship Summary)**:
   - **Focus**: A concise, easy-to-read summary that helps retail investors understand the nature of their relationship with the firm.
   - **Contents**:
     - Key information about the services provided.
     - Fees, costs, conflicts of interest, and the firm's legal obligations.
     - Comparison of advisory and brokerage services (if applicable).
...
Investment advisers must update their ADV forms annually, or more frequently if there are material changes, ensuring that clients and regulators always have access to the most current information.

he Investment Advisers Act of 1940 requires investment advisers to give each advisory client several disclosure documents. Form ADV, Part 2A is the brochure and discloses information about the IA firm. Part 2B, known as the brochure supplement, discloses information about the specific IAR who will offer advice and make discretionary decisions for the client. Regulation Best Interest (Reg BI) further requires delivery of Part 3, which is the client relationship summary.

NASAA rules require a brochure to delivered to a new client at least 48 hours prior to entering into an advisory contract with the client. Alternatively, the advisor may deliver the brochure at the time the contract is executed, provided the client has the right to cancel the contract w/o penalty during the first five business days after executing the contract. This means that the client may recover any "setup" fees that were paid to the advisor, but not fees for any advisory services that were paid during those first five business days.
